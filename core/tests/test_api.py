...
class TestApi(APITestCase):
    ...
    def setUp(self):
        ...
        self.cliente1 = Cliente(nome='cliente1', email='cliente1@email.com', telefone='+5511972345738')
        self.cliente1.save()
        self.projeto1 = Projeto(nome='projeto1', descricao='Primeiro Projeto', cliente=self.cliente1)
        self.projeto1.save()
        self.atividade1 =Atividade(projeto=self.projeto1, descricao='Primeira Atividade', prazo=date(2024, 12, 31))
    ...
    def test_create_cliente(self):
        ...
        response = self.client.post(
            self.cliente_list, self.cliente_data, format="json"
        )
    ...
    def test_create_projeto(self):
        """Test if POST request is returning 201"""
        response = self.client.post(
            self.projeto_list, self.projeto_data, format="json"
        )
        self.assertTrue(response.data)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
